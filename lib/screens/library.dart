                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Expanded(
                                    child: Text("How to prepare a Soul Cake")),
                                // IconButton(
                                //   onPressed: null,
                                //   color: Colors.white,
                            ...
                            Padding(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: <Widget>[
                                  Expanded(child: Text("Michael Bruno")),
                                ],
                              ),
                            )
                          ],
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 16.0),
                      child: Column(
                        children: <Widget>[Text("Favorites"), Text("0 Video")],
                      ),
                    )
                  ],
                ),
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Padding(
                            ...
                            child: Text(
                              "New list",
                              style: TextStyle(color: Color(0xff48B589)),
                            ),
                          )
                        ],
                      ),
